...
def _evaluate_projection_requirements(
    ...
    *,
    ...
    for idx, effect in enumerate(action.resource_effects):
        effect_requires_resource = effect.effect_type in {
            "consume",
            "transfer",
        }
        resource_available = (
...
def _mark_perception_as_projected(
    perception: Perception,
) -> None:
...
class ActionProjection:
    ...
    def __post_init__(self) -> None:
        _require_non_empty(
            self.action_id,
            "ActionProjection action_id cannot be empty",
        )
        _require_non_empty(
            self.actor_id,
            "ActionProjection actor_id cannot be empty",
        )
        _require_non_empty(
            self.source_perception_id,
        ...
        _require_non_empty(
            self.source_id,
            "ActionProjection source_id cannot be empty",
        )
...
class ProjectionBatch:
    ...
    def __post_init__(self) -> None:
        _require_non_empty(
            self.actor_id,
            "ProjectionBatch actor_id cannot be empty",
        )
        _require_non_empty(
            self.source_perception_id,
        ...
        _require_non_empty(
            self.source_id,
            "ProjectionBatch source_id cannot be empty",
        )
