...
from examples.lab5_behavior_sim.graph_gen import build_graph, bfs_distances
from examples.lab5_behavior_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.lab5_behavior_sim.perception import (
...
def test_node_flip_seizes_spice():
    ...
    from examples.lab5_behavior_sim.engine import _apply_conquest
