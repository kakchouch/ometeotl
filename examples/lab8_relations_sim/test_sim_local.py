...
from examples.lab8_relations_sim.graph_gen import build_graph, bfs_distances
from examples.lab8_relations_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.lab8_relations_sim.perception import (
...
def test_node_flip_seizes_spice():
    ...
    from examples.lab8_relations_sim.engine import _apply_conquest
