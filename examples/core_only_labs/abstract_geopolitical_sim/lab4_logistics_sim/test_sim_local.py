"""Tests for Lab 4 — Logistics multi-agent simulation.

These tests live in examples and are NOT part of the tracked tests/ tree.
Run with:
    python -m pytest -q examples/lab4_logistics_sim/test_sim_local.py
"""
...
from examples.core_only_labs.abstract_geopolitical_sim.lab4_logistics_sim.config import SimConfig
from examples.core_only_labs.abstract_geopolitical_sim.lab4_logistics_sim.graph_gen import build_graph, bfs_distances
from examples.core_only_labs.abstract_geopolitical_sim.lab4_logistics_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.core_only_labs.abstract_geopolitical_sim.lab4_logistics_sim.perception import (
...
def test_create_sim_factions_have_no_spice_stock():
    """Faction has no spice_stock attribute (removed in Lab 4)."""
...
def test_node_flip_seizes_spice():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab4_logistics_sim.engine import _apply_conquest
