...
class ResourceEffect:
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "ResourceEffect":
        ...
        return cls(
            ...
            effect_type=_str_from_data(data, "effect_type", "consume"),
            quantity=(
...
class ActionPrerequisite:
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "ActionPrerequisite":
        ...
        return cls(
            prerequisite_type=_str_from_data(data, "prerequisite_type", "resource"),
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "Action":
        ...
        return cls(
            **_base_kwargs_from_typed_payload(data, "action"),
            ...
            action_type=_str_from_data(data, "action_type", "generic"),
            resource_effects=[
            ...
            outcome_description=_str_from_data(data, "outcome_description", ""),
            state_changes=_dict_from_data(data, "state_changes"),
        )
