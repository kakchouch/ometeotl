/**
 * app.js — Lab 9 Globalization Simulation client
 *
 * Responsibilities:
...
const API = "http://127.0.0.1:8773";  // Lab 9 server port
...
function renderGlobalization(state) {
