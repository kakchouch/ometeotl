"""Minimal HTTP server for the Lab 8 Relations simulation web UI.
...
PORT = 8772  # Dedicated Lab 8 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 8 (Relations) server running at http://127.0.0.1:{port}/")
