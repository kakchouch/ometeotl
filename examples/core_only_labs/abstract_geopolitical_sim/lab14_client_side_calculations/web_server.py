"""Minimal HTTP server for the Lab 14 Client-Side Calculations simulation web UI.
...
PORT = 8777  # Dedicated Lab 14 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 14 (Client-Side Calculations) server running at http://127.0.0.1:{port}/")
