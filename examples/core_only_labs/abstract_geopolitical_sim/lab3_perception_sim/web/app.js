/**
 * app.js — Lab 3 Limited Perception Multi-Agent Graph Simulation client
 *
 * Responsibilities:
 ...
 *  - Support perception_mode (limited vs full vision)
 */

"use strict";

const API = "http://127.0.0.1:8767";  // Lab 3 server port
...
function readConfigForm() {
  ...
  for (const [key, val] of fd.entries()) {
    if (key === "layout" || key === "graph_mode" || key === "perception_mode") {
      cfg[key] = val;
      continue;
    }
