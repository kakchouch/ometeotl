...
from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.config import SimConfig
from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.graph_gen import build_graph, bfs_distances
from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.perception import (
...
def test_create_sim_assigns_behavior_per_faction():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.engine import _genome_to_ecloz
...
def test_node_flip_seizes_spice():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.engine import _apply_conquest
...
def test_diplo_reduces_attacker_aggression():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.engine import _relation_pressure_factor
...
def test_cohe_raises_secession_threshold():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab11_technology.engine import _mutate_and_check_secession
