"""Minimal HTTP server for the Lab 10 Complex Behavior simulation web UI.
...
PORT = 8774  # Dedicated Lab 10 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 10 (Complex Behavior) server running at http://127.0.0.1:{port}/")
