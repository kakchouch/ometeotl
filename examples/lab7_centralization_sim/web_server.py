"""Minimal HTTP server for the Lab 7 Centralization simulation web UI.
...
PORT = 8771  # Dedicated Lab 7 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 7 (Centralization) server running at http://127.0.0.1:{port}/")
