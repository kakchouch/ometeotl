"""Minimal HTTP server for the Lab 6 Vassal Hierarchy simulation web UI.
...
PORT = 8770  # Dedicated Lab 6 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 6 (Vassal Hierarchy) server running at http://127.0.0.1:{port}/")
