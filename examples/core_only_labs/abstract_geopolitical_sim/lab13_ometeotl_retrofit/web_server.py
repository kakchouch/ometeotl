"""Minimal HTTP server for the Lab 13 Ometeotl Retro-Fit simulation web UI.
...
PORT = 8776  # Dedicated Lab 13 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 13 (Ometeotl Retro-Fit) server running at http://127.0.0.1:{port}/")
