...
from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.config import SimConfig
from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.graph_gen import build_graph, bfs_distances
from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.perception import (
...
def test_create_sim_assigns_behavior_per_faction():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.engine import _genome_to_ecloz
...
def test_node_flip_seizes_spice():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab10_complex_behavior_sim.engine import _apply_conquest
