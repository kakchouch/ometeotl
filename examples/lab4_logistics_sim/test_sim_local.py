...
from examples.lab4_logistics_sim.graph_gen import build_graph, bfs_distances
from examples.lab4_logistics_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.lab4_logistics_sim.perception import (
...
def test_node_flip_seizes_spice():
    ...
    from examples.lab4_logistics_sim.engine import _apply_conquest
