...
from examples.lab9_globalization_sim.graph_gen import build_graph, bfs_distances
from examples.lab9_globalization_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.lab9_globalization_sim.perception import (
...
def test_node_flip_seizes_spice():
    ...
    from examples.lab9_globalization_sim.engine import _apply_conquest
