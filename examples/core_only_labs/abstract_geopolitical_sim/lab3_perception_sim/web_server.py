"""Minimal HTTP server for the multi-agent graph simulation web UI (Lab 3 - Perception Variant).
...
PORT = 8767  # Different port from Lab 2 to avoid conflicts
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 3 (Perception) server running at http://127.0.0.1:{port}/")
