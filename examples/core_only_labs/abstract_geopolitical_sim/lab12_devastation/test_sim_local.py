"""Tests for Lab 12 — Devastation.

Invariant tests are written before implementation, as required by the spec.

Run with:
    python -m pytest -q examples/lab12_devastation/test_sim_local.py
"""
...
from examples.core_only_labs.abstract_geopolitical_sim.lab12_devastation.config import SimConfig
from examples.core_only_labs.abstract_geopolitical_sim.lab12_devastation.engine import (
    SimState,
    Node,
    Faction,
    BehaviorProfile,
...
from examples.core_only_labs.abstract_geopolitical_sim.lab12_devastation.perception import get_faction_perception
