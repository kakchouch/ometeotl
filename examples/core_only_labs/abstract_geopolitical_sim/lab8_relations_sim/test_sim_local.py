"""Tests for Lab 8 — Relations multi-agent simulation.

These tests live in examples and are NOT part of the tracked tests/ tree.
Run with:
    python -m pytest -q examples/lab8_relations_sim/test_sim_local.py
"""
...
from examples.core_only_labs.abstract_geopolitical_sim.lab8_relations_sim.config import SimConfig
from examples.core_only_labs.abstract_geopolitical_sim.lab8_relations_sim.graph_gen import build_graph, bfs_distances
from examples.core_only_labs.abstract_geopolitical_sim.lab8_relations_sim.engine import (
    SimState,
    Node,
    Link,
    Faction,
...
from examples.core_only_labs.abstract_geopolitical_sim.lab8_relations_sim.perception import (
...
def test_node_flip_seizes_spice():
    ...
    from examples.core_only_labs.abstract_geopolitical_sim.lab8_relations_sim.engine import _apply_conquest
