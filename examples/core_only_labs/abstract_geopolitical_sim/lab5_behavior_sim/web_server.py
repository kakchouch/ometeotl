"""Minimal HTTP server for the Lab 5 Behavior Logistics simulation web UI.
...
PORT = 8769  # Different port from Lab 5 predecessors to avoid conflicts
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 5 (Behavior Logistics) server running at http://127.0.0.1:{port}/")
