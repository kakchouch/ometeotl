"""Minimal HTTP server for the Lab 4 Logistics multi-agent simulation web UI.
...
PORT = 8768  # Different port from Lab 3 to avoid conflicts
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 4 (Logistics) server running at http://127.0.0.1:{port}/")
