"""Tests for masm.core.authority and world authority boundaries."""
...
def test_world_local_mode_mutations_do_not_require_authority_token():
    """Local usage keeps direct mutation behavior by default."""
...
def test_authority_sequence_history_is_bounded():
    ...
    assert result_two.accepted is True
    assert result_three.accepted is True
    assert result_four.accepted is True
    assert result_five.accepted is False
