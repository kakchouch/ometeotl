"""Minimal HTTP server for the Lab 12 Devastation simulation web UI.
...
PORT = 8775  # Dedicated Lab 12 port
...
def run_server(port: int = PORT) -> None:
    ...
    print(f"Lab 12 (Devastation) server running at http://127.0.0.1:{port}/")
