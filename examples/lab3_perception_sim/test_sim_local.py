...
from examples.lab3_perception_sim.graph_gen import build_graph, bfs_distances
from examples.lab3_perception_sim.engine import (
    SimState,
    create_sim,
    step,
    serialize_state,
...
from examples.lab3_perception_sim.perception import (
